...
public class ArticleController {
	...
	public String articleForm(@ModelAttribute("vo") ArticleVo vo, Model model, Game gDto, GameVo gVo) throws Exception {
		...
		model.addAttribute("league", gService.league(gDto));
