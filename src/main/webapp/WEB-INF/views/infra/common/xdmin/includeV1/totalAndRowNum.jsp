...
<div class="container-fluid px-0 mt-1 mb-3">
    <div class="row">
        <div class="col-9 col-md-10 col-xl-10 text-start pt-1">
			<c:choose>
				<c:when test="${not empty vo.totalRows}">        
					<span style="margin: 0; padding: 0; font-weight: 800;">Total : <fmt:formatNumber value="${vo.totalRows}" pattern="#,###"/></span>
				</c:when>
				<c:otherwise>            
